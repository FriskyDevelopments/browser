...
const cfg = {
  ...
  scanIntervalMs:     envInt ('ZOOM_HOST_SCAN_INTERVAL_MS',         2500),
  menuOpenWaitMs:     envInt ('ZOOM_HOST_MENU_OPEN_WAIT_MS',         600),
  menuClickRetries:   envInt ('ZOOM_HOST_MAX_MENU_RETRIES',            3),
  menuRetryWaitMs:    envInt ('ZOOM_HOST_MENU_RETRY_WAIT_MS',         400),
  zoomReadyTimeoutS:  envInt ('ZOOM_HOST_ZOOM_READY_TIMEOUT_S',       60),
  // zoom-host-automation.user.js config
...
function injectHostToolsConfig(source) {
  ...
  const CONFIG = {
    ...
    MENU_OPEN_WAIT_MS: ${cfg.menuOpenWaitMs},
    MENU_CLICK_RETRIES: ${cfg.menuClickRetries},
    MENU_RETRY_WAIT_MS: ${cfg.menuRetryWaitMs},
    SPAM_PATTERNS: [
      ${spamPatternsLiteral},
    ],
    ZOOM_READY_TIMEOUT_S: ${cfg.zoomReadyTimeoutS},
  };
  // @@DOPPLER_CONFIG_END`;
